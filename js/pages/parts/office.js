import { PRODUITS_CONFISERIE } from "../../data/concessions.js?v=d8ca144d";
import { deconnexion } from "../../auth.js?v=d8ca144d";
import { confiserieActive, tauxAchat } from "../../data/concessions.js?v=d8ca144d";
import { obtenirBonusSalle } from "../../data/upgrades.js?v=d8ca144d";
import { Etat, fmtArgent } from "../../game-state.js?v=d8ca144d";
import { bobCompact } from "../../navigation.js?v=d8ca144d";
import { majBadgeNotifications } from "./community-social.js?v=d8ca144d";
import {
  XP,
  deblocagesPrevus,
  deblocagesReels,
  ...
  recompenseParCle,
  xpActuel
} from "../../progression.js?v=d8ca144d";
