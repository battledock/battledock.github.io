import { couleurSiegesCle } from "../data/customization.js?v=b1e4da88";
import { bulleSalles, ouvrePanneauEquipement } from "../rooms.js?v=b1e4da88";
import { A } from "./genre-posters.js?v=b1e4da88";
