import { couleurSiegesCle } from "../data/customization.js?v=cbbef1bf";
import { bulleSalles, ouvrePanneauEquipement } from "../rooms.js?v=cbbef1bf";
import { A } from "./genre-posters.js?v=cbbef1bf";
