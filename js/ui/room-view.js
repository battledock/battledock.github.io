import { couleurSiegesCle } from "../data/customization.js?v=5897dbca";
import { bulleSalles, ouvrePanneauEquipement } from "../rooms.js?v=5897dbca";
import { A } from "./genre-posters.js?v=5897dbca";
