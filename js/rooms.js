...
import { accomplitMission, bulleXP, chargeProgression, infoNiveau, majBarreXPHeader, montreMonteeNiveau, synchroniseDeblocages } from "./progression.js?v=22580e0f";
import { activeConfiserieSiBesoin, inaugurationConfiserie } from "./data/concessions.js?v=22580e0f";
import { chargeCinema } from "./game-state.js?v=22580e0f";
...
import {
  ...
  prochaineExtension
} from "./data/upgrades.js?v=22580e0f";
import { Etat, fmtArgent, rafraichirEtat } from "./game-state.js?v=22580e0f";
import { bobCompact } from "./navigation.js?v=22580e0f";
import { niveauActuel, sonNiveau } from "./progression.js?v=22580e0f";
import { appelSecurise, idOperation, rpc, sbFetch } from "./supabase-client.js?v=22580e0f";
import { echappe } from "./ui/emblems.js?v=22580e0f";
import { icone } from "./ui/icons.js?v=22580e0f";
import { apercuEquipement, brancheZonesSalle, salleEnCoupe } from "./ui/room-view.js?v=22580e0f";
