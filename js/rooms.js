...
import { accomplitMission, bulleXP, chargeProgression, infoNiveau, majBarreXPHeader, montreMonteeNiveau, synchroniseDeblocages } from "./progression.js?v=3c723c08";
...
import {
  ...
  prochaineExtension
} from "./data/upgrades.js?v=3c723c08";
import { Etat, fmtArgent, rafraichirEtat } from "./game-state.js?v=3c723c08";
import { bobCompact } from "./navigation.js?v=3c723c08";
import { niveauActuel, sonNiveau } from "./progression.js?v=3c723c08";
import { appelSecurise, idOperation, rpc, sbFetch } from "./supabase-client.js?v=3c723c08";
import { echappe } from "./ui/emblems.js?v=3c723c08";
import { icone } from "./ui/icons.js?v=3c723c08";
import { apercuEquipement, brancheZonesSalle, salleEnCoupe } from "./ui/room-view.js?v=3c723c08";
