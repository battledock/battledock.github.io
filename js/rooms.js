...
import { accomplitMission, bulleXP, chargeProgression, infoNiveau, majBarreXPHeader, montreMonteeNiveau, synchroniseDeblocages } from "./progression.js?v=92b49fe3";
import { activeConfiserieSiBesoin, inaugurationConfiserie } from "./data/concessions.js?v=92b49fe3";
import { chargeCinema } from "./game-state.js?v=92b49fe3";
...
import {
  ...
  prochaineExtension
} from "./data/upgrades.js?v=92b49fe3";
import { Etat, fmtArgent, rafraichirEtat } from "./game-state.js?v=92b49fe3";
import { bobCompact } from "./navigation.js?v=92b49fe3";
import { niveauActuel, sonNiveau } from "./progression.js?v=92b49fe3";
import { appelSecurise, idOperation, rpc, sbFetch } from "./supabase-client.js?v=92b49fe3";
import { echappe } from "./ui/emblems.js?v=92b49fe3";
import { icone } from "./ui/icons.js?v=92b49fe3";
import { apercuEquipement, brancheZonesSalle, salleEnCoupe } from "./ui/room-view.js?v=92b49fe3";
