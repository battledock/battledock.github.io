...
import { accomplitMission, bulleXP, chargeProgression, infoNiveau, majBarreXPHeader, montreMonteeNiveau, synchroniseDeblocages } from "./progression.js?v=1e9eaaa6";
import { activeConfiserieSiBesoin, inaugurationConfiserie } from "./data/concessions.js?v=1e9eaaa6";
import { chargeCinema } from "./game-state.js?v=1e9eaaa6";
import { majHeaderArgent } from "./navigation.js?v=1e9eaaa6";
...
import {
  ...
  prochaineExtension
} from "./data/upgrades.js?v=1e9eaaa6";
import { Etat, fmtArgent, rafraichirEtat } from "./game-state.js?v=1e9eaaa6";
import { bobCompact } from "./navigation.js?v=1e9eaaa6";
import { niveauActuel, sonNiveau } from "./progression.js?v=1e9eaaa6";
import { appelSecurise, idOperation, rpc, sbFetch } from "./supabase-client.js?v=1e9eaaa6";
import { echappe } from "./ui/emblems.js?v=1e9eaaa6";
import { icone } from "./ui/icons.js?v=1e9eaaa6";
import { apercuEquipement, brancheZonesSalle, salleEnCoupe } from "./ui/room-view.js?v=1e9eaaa6";
